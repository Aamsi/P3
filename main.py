...
from core import (Maze, Character, Item, load_image, draw_sprite,
                  load_counter_sprite, win_sprite)
...
def main():
    ...
    while not win:
        ...
        # Characters
        macgyver = Character(start_position[0], start_position[1])
        guardian = Character(end_position[0], end_position[1])
